...
class MpiSum(recipe.Recipe):
    ...
    def _mapper_func(report_path, parsed_args):
        ...
        err_msg = service.filter_and_adjust_time(mpi_df)
        ...
        mpi_df["duration"] = mpi_df["end"] - mpi_df["start"]
        mpi_df = mpi_df[mpi_df["duration"] > 0]
        range_gdf = mpi_df[["text", "duration"]].groupby("text")
